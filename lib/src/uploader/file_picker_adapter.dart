...
/// Abstraction over [file_picker] so widget tests can substitute a fake.
...
class DefaultFilePickerAdapter implements FilePickerAdapter {
  ...
  static List<String> _extensionsFor(Set<MediaKind> kinds) {
    final ext = <String>[];
  ...
  static MediaKind? _kindFor(String? ext, Set<MediaKind> allowed) {
